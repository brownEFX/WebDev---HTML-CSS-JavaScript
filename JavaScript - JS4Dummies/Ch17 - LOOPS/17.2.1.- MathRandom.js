...
console.log(`Random number between 0 and 10 (Math Random * 10): ${mathRandom * 10}`);
console.log(`Random number between 0 and 10 (Math Random * 11): ${mathRandom * 11}`);
console.log(`Remove decimals with Math.floor (Math Random * 11): ${Math.floor(mathRandom * 11)}`);

console.log("Random number btn x and y where y < x: Math.floor(mathRandom * (x - y) + y)" )
console.log(`random number between 10 and 1,00: ${Math.floor(mathRandom * (100 - 10) + 10)}`);
console.log(`random number between 100 and 1,000: ${Math.floor(mathRandom * (1000 - 100) + 100)}`);
    ...
    //7.3. Create a random index.
        ...
        console.log(`randomIndex = Math.floor(Math.random() * randomWords.length: ${randomIndex}`);
